...
|**Optimal Stopping**<br>_How do you when to stop? Can you know when to stop? Optimal stopping theory allows us to make a decision on when to stop based on an empirical argument. That's not to say it's derived from empirical evidence, but it is established a priori._|
